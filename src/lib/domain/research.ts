...
export const RESEARCH_FIELD_DEFINITIONS: readonly ResearchFieldDefinition[] = [
  ...
  { fieldName: "address_raw", kind: "TEXT", appliesTo: "PROPERTY", label: "Endereço como publicado" },
  ...
  { fieldName: "private_area", kind: "NUMBER", appliesTo: "PROPERTY", unit: "m2", label: "Área privativa" },
  { fieldName: "usable_area", kind: "NUMBER", appliesTo: "PROPERTY", unit: "m2", label: "Área útil" },
  { fieldName: "built_area", kind: "NUMBER", appliesTo: "PROPERTY", unit: "m2", label: "Área construída" },
  { fieldName: "total_area", kind: "NUMBER", appliesTo: "PROPERTY", unit: "m2", label: "Área total" },
  { fieldName: "land_area", kind: "NUMBER", appliesTo: "PROPERTY", unit: "m2", label: "Área do terreno" },
  ...
  { fieldName: "construction_year", kind: "NUMBER", appliesTo: "PROPERTY", label: "Ano de construção" },
  { fieldName: "condition_status", kind: "TEXT", appliesTo: "PROPERTY", label: "Estado declarado" },
  { fieldName: "asking_price", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "Preço pedido" },
  { fieldName: "transaction_price", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "Preço transacionado" },
  { fieldName: "asking_monthly_rent", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "Aluguel pedido" },
  { fieldName: "contracted_monthly_rent", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "Aluguel contratado" },
  { fieldName: "publication_date", kind: "DATE", appliesTo: "OBSERVATION", label: "Data de publicação" },
  { fieldName: "transaction_date", kind: "DATE", appliesTo: "OBSERVATION", label: "Data da transação" },
  { fieldName: "condo_fee", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "Condomínio" },
  { fieldName: "property_tax", kind: "MONEY", appliesTo: "OBSERVATION", unit: "BRL", label: "IPTU" },
  { fieldName: "broker_name", kind: "TEXT", appliesTo: "OBSERVATION", label: "Anunciante" },
  { fieldName: "external_listing_id", kind: "TEXT", appliesTo: "OBSERVATION", label: "Código do anúncio" },
  { fieldName: "listing_status", kind: "TEXT", appliesTo: "OBSERVATION", label: "Situação do anúncio" },
] as const;
